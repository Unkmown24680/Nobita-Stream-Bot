    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Nobita](https://telegram.me/SM_contactadmin_bot) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/SM_contactadmin_bot)**",
...
<b>❇️  ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @movierulzking</b>"""
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton(' 🔰 Join update & Backup Channel 🔰 ', url='https://telegram.me/movierulzking')]])
        )
